...
function MenuButton({children}: MenuButtonProps) {
    return (
        <div className="flex items-center justify-center border-2 border-(--strava-ozadje) text-3xl rounded-[35px] w-38 h-18 bg-black cursor-pointer text-(--strava-button) active:bg-white duration-700">
            {children}
        </div>
    )
}
